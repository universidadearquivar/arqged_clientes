...
{% hint style="warning" %}
<mark style="color:orange;">A função</mark> <mark style="color:orange;"></mark><mark style="color:orange;">**"Enviar para a Caixa"**</mark> <mark style="color:orange;"></mark><mark style="color:orange;">é utilizado também quando necessário transferir um registro de caixa, como por exemplo, a indexação foi realizada de forma indevida na caixa 1010, sendo que fisicamente o documento encontra-se na caixa 1020. Para alterar, basta realizar o envio do documento para a caixa correta.</mark>
{% endhint %}
