...
<mark style="color:red;">Na nova rota será necessário além do usuário e senha, enviar também a SubscriptionKey (Chave de Assinatura ou Chave de API). A</mark> [<mark style="color:red;">**Chave de API**</mark>](broken-reference) <mark style="color:red;">poderá ser gerada por um usuário com as devidas permissões no ArqGED.</mark>&#x20;
