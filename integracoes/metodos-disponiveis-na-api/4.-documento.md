...
## 4.3.GET Buscar documentos de um Cliente V1
...
## 4.4.DELETE Deletar um documento de um Cliente V1
...
## 4.5.POST Cadastrar um documento de um Cliente: com compartilhamento V2
