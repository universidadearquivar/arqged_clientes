...
Crie o(s) novo(s) usuário(s) preenchendo os dados da [aba usuário](metodos-disponiveis-na-api.md#aba-usuario), depois acesse o usuário que deve ser utilizado como "espelho" e em "Permissões I" clique na opção  **"Copiar as Permissões para outro usuário do cliente".**
...
<mark style="color:red;">Retorne ao usuário e realize as configurações necessárias.</mark>
{% endhint %}
