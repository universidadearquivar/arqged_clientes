...
2. [Limites de Requisições da API](api/limites-de-requisicoes-da-api.md)
3. [Métodos disponíveis da API ](api/metodos-disponiveis-na-api/)
4. [URL da API ArqGED](api/url-da-api-arqged.md)
5. [Histórico de alterações da API ](api/historico-de-alteracoes-da-api.md)
