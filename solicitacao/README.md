...
Nele são exibidas todas as solicitações de consulta e devolução referentes a serviços de guarda de documentos, podendo ser de Guarda Terceirizada, quando o documento é alocado em uma Unidade Arquivar ou de Guarda Interna, quando o próprio cliente possui um local destinado à guarda e gestão de seus documentos.
